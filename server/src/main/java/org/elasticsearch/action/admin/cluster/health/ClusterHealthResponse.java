...
public class ClusterHealthResponse extends ActionResponse implements StatusToXContentObject {
    ...
    private static final String READ_ONLY_INDICES = "read_only_indices";
    ...
    private static final ConstructingObjectParser<ClusterHealthResponse, Void> PARSER =
            new ConstructingObjectParser<>("cluster_health_response", true,
                    parsedObjects -> {
                        ...
                        int readOnlyIndices = (int) parsedObjects[i++];
    ...
    static {
        ...
        PARSER.declareInt(constructorArg(), new ParseField(READ_ONLY_INDICES));
    ...
    public int getReadOnlyIndices() {
        return clusterStateHealth.getReadOnlyIndices();
    }
    ...
    public XContentBuilder toXContent(XContentBuilder builder, Params params) throws IOException {
        ...
        builder.field(READ_ONLY_INDICES, getReadOnlyIndices());
