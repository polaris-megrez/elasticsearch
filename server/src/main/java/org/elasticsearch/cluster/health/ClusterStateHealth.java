...
public final class ClusterStateHealth implements Iterable<ClusterIndexHealth>, Writeable {
    ...
    private final int readOnlyIndices;
    ...
    public ClusterStateHealth(final ClusterState clusterState, final String[] concreteIndices) {
        ...
        indices = new HashMap<>();
        int computeReadOnlyIndices = 0;
        for (String index : concreteIndices) {
            IndexRoutingTable indexRoutingTable = clusterState.routingTable().index(index);
            IndexMetadata indexMetadata = clusterState.metadata().index(index);
            if (indexMetadata.getSettings().getAsBoolean(IndexMetadata.SETTING_READ_ONLY_ALLOW_DELETE, false)){
                computeReadOnlyIndices ++;
            }
        ...
        this.readOnlyIndices = computeReadOnlyIndices;
    ...
    public ClusterStateHealth(int activePrimaryShards, int activeShards, int relocatingShards, int initializingShards, int unassignedShards,
        ...
        Map<String, ClusterIndexHealth> indices, int readOnlyIndices) {
        this.activePrimaryShards = activePrimaryShards;
        this.activeShards = activeShards;
        this.relocatingShards = relocatingShards;
        this.readOnlyIndices = readOnlyIndices;
    ...
    public boolean equals(Object o) {
        ...
        return numberOfNodes == that.numberOfNodes &&
                ...
                readOnlyIndices == that.readOnlyIndices &&
    ...
    @Override
    public int hashCode() {
        return Objects.hash(numberOfNodes, numberOfDataNodes, activeShards, readOnlyIndices, relocatingShards, activePrimaryShards, initializingShards,
